...
<head>
    ...
    <title>Admin Dashboard - Kamwala</title>
    ...
    <div class="row">
        ...
        <div class="d-md-none bg-white border-bottom sticky-top">
            <div class="d-flex justify-content-between align-items-center p-3">
                <a href="dashboard.php" class="text-decoration-none">
                    <img src="../assets/images/kamwala_logo.webp" alt="Kamwala Logo" style="height: 40px;">
                </a>
        ...
        <div class="col-md-3 col-lg-2 px-0 admin-sidebar d-none d-md-block">
            <div class="p-4 border-bottom">
                <a href="dashboard.php" class="text-decoration-none">
                    <img src="../assets/images/kamwala_logo.webp" alt="Kamwala Logo" class="img-fluid" style="max-height: 50px;">
                </a>
            </div>
            <div class="p-3">
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link <?php echo $current_page == 'bookings.php' ? 'active' : ''; ?>" href="bookings.php">
                        <i class="bi bi-calendar-check"></i> Mobile Bookings
                    </a>
