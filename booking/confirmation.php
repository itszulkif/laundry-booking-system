                    ...
                    <ul class="list-group list-group-flush mb-4">
                        <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div>
                                ...
                                <small class="text-muted d-block"><?php echo $quantity; ?> <?php echo $service['price_unit'] == 'kg' ? 'kg' : 'items'; ?> x PKR <?php echo number_format($service['price'], 2); ?></small>
                            </div>
                            <span>PKR <?php echo number_format($subtotal, 2); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                            <div>
                                GST (10%)
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center px-0 fw-bold fs-5">
                            Total
                            <span class="text-primary">PKR <?php echo number_format($total_price, 2); ?></span>
                        </li>
                    </ul>
