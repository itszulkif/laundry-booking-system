...
// Price calculation moved to later steps
// Fetch Service Name for summary
$price_query = "SELECT name FROM services WHERE id = $service_id";
                                ...
                                <div class="col-md-6">
                                    <label class="border rounded p-3 d-flex align-items-center cursor-pointer h-100 w-100 staff-card position-relative" id="staff-card-<?php echo $staff['id']; ?>">
                                        ...
                                        <div>
                                            ...
                                            <div class="mb-1">
                                                <span class="badge bg-primary-soft text-primary">Daily Rate: PKR <?php echo number_format($staff['daily_rate'], 2); ?></span>
                                            </div>
            ...
            <div class="col-lg-4">
                <div class="antigravity-card p-4 sticky-top" style="top: 100px;">
                    ...
                    <div class="d-flex justify-content-between mb-4">
                        ...
                        <span class="fw-bold fs-5 text-muted">To be calculated</span>
                    </div>
