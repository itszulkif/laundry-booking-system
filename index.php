            ...
            <div class="col-lg-8 col-xl-6">
                ...
                <div class="mb-4 animate__animated animate__fadeInDown">
                    <a class="text-decoration-none" href="<?php echo $base_url; ?>/index.php">
                        <img src="assets/images/kamwala_logo.webp" alt="Kamwala Logo" class="img-fluid" style="max-height: 120px;">
                    </a>
                </div>

                <!-- Paragraph -->
                <p class="lead text-muted mb-5 animate__animated animate__fadeInUp animate__delay-1s px-md-5">
                    Kamwala - Professional laundry service at your doorstep. Experience the antigravity of cleanliness with our premium wash & fold, dry cleaning, and ironing services.
                ...
                <div class="antigravity-card p-4 p-md-5 animate__animated animate__fadeInUp animate__delay-2s mx-auto w-100">
                    <form action="booking/services.php" method="GET">
                        <label for="city" class="form-label fw-bold text-uppercase small text-muted mb-3 d-block text-start">Select Your Zone</label>
                        <div class="input-group input-group-lg mb-4">
                            ...
                            <select class="form-select form-control-clean border-start-0 ps-0 fs-5" id="city" name="city_id" required style="height: 60px;">
                                ...
                                <?php if ($cities_result->num_rows > 0): ?>
                                    ...
                                    <?php endwhile; ?>
                                <?php else: ?>
                                    <option value="" disabled>No Zone available yet</option>
                                <?php endif; ?>
                            </select>
                        </div>
